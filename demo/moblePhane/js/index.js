 ...
 */
var canvas=document.getElementById("canvas"),height=$(window).height(), width=$(document.body).width();
      ...
      function heroPeo(heroImg){
       ...
       //画布添加移入事件
          canvas.addEventListener("touchstart",function(e){
              var x=e.touches[0].pageX-heroImg[0].width/2,
                  y=e.touches[0].pageY-heroImg[0].height/2;
              hero.x=x;hero.y=y;
          },false)
