...
$(function(){
    ...
    $(".btnOK").click(function(e){
        ...
        $.ajax({
            ...
            data:{id:$(this).attr("title"),uid:m_uid},
    ...
    if(selects==1){
        $.ajax({
            ...
            success:function(res){
                ...
                userList.image==undefined?userList.image="../../img/icon/d_head.png":userList.image=userList.image;
                userList.constellation==""?userList.constellation="未知":userList.constellation=userList.constellation;
                $(".top_nav span").text(userList.nickname+"的动态");
                ...
                $.each(list,function(i,k){
                    ...
                    var html="<li class='dynamic_user_item' title="+k.id+"><h1 class='Item_timer'>"+
                        ...
                        "<div class='Item_kind'><span class='Sp'>"+k.give+"点赞</span><span>"+k.read+"阅读</span><span>"+k.comment+"评论</span><span class='delete' title="+k.id+">删除</span>"+
                  ...
                  if(live==0){
                      $.ajax({
                          ...
                          success:function(res){
                              ...
                              fadeTagle(that,"已关注","../../img/icon/h_report.png");
                              live=1;
                          }
                      })
                  }else if(live==1){
                      $.ajax({
                          ...
                          success:function(res){
                              ...
                              fadeTagle(that,"取消关注","../../img/icon/h_report.png");
                              live=0;
                          }
                      })
                   }
                ...
                $(".delete").click(function(e){
                    e.stopPropagation(); $("#deleteBox").show();
                    $(".btnOK").attr("title",$(this).attr("title"));
