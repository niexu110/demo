...
//	var cache = 1;
	...
	function addBomb(){
        ...
        "<p style='font-size: .24rem;color:#363636;height:.6rem;line-height: .6rem;'>如果想脱单就大胆的秀出自我!</p>" +
    ...
    "<p style='font-size: .24rem;color:#5793dd;height:.6rem;line-height: .6rem;'>您的头像正在审核中，</p>" +
    "<p style='font-size: .24rem;color:#5793dd;height:.6rem;line-height: .6rem;'>审核通过后即可与其他用户互动了</p>" +
    "</div>";
				...
				if(data.code==200){
					...
					for (var i = 0; i< len; i++) {
						...
						if(data.data[i].hongbao==1){
							...
							var delay=''; 
							var Img='';
							obj.el.append('<li class="hogbao"><a  data-id="'+data.data[i].uid+'" href="javascript:void(0)"><div class="proposeLeft"><img src="'+data.data[i].image+'"></div><div class="proposeRight"><h1>'+data.data[i].nickname+'<span>'+data.data[i].distance+'km</span></h1><p><span class="'+sexClass+'"><img src="'+sexSrc+'"><s>'+data.data[i].age+'</s></span><i>'+data.data[i].constellation+'</i><i>魅力值：<img class="charm" src="'+charm+'" alt=""></i></p><h6>'+data.data[i].myideal+'</h6></div></a></li>');
							if(obj.dataId==1){
								dataObj.propse=true;
							}else if(obj.dataId==2){
								dataObj.near=true;
							...
							obj.el.append('<li><a class="datum" data-id="'+data.data[i].uid+'" href="src/find/personalcarte.html?dataId='+data.data[i].uid+'"><div class="proposeLeft"><img src="'+data.data[i].image+'"></div><div class="proposeRight"><h1>'+data.data[i].nickname+'<span>'+data.data[i].distance+'km</span></h1><p><span class="'+sexClass+'"><img src="'+sexSrc+'"><s>'+data.data[i].age+'</s></span><i>'+data.data[i].constellation+'</i><i>魅力值：<img class="charm" src="'+charm+'" alt=""></i></p><h6>'+data.data[i].myideal+'</h6></div></a></li>');
							if(obj.dataId==1){
								dataObj.propse=true;
							}else if(obj.dataId==2){
								dataObj.near=true;
