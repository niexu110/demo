            ...
            success:function(data){
                if(data.code==200){
                    if(data.data.status==0){
                        $(".d_headImgBox span").css("display","block");
                        $(".d_headImgBox span").text("审核中")
                    }else if(data.data.status==1){
                        $(".d_headImgBox span").css("display","none");
                    }else if(data.data.status==2){
                        $(".d_headImgBox span").css("display","block");
                        $(".d_headImgBox span").text("审核失败")
                    }
                }
            }
        });
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.code=200){
					...
					/* 头像跳转 */
                    $(".d_headImgBox").on("click",function(){
